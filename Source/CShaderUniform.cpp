...
namespace glliba
{
	...
	void CShaderUniform::setUniform( SHADER_UNIFORM_TYPE _eType, std::string _attribute, void* _value )
	{
		m_eShaderType = _eType;
		m_attribute = _attribute;
		m_uniformValue = allocMemory(_eType, _value);
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////

	void* CShaderUniform::allocMemory( SHADER_UNIFORM_TYPE _eType,  void* _value )
	{
		if (m_uniformValue != NULL)
		{
			delete m_uniformValue;
